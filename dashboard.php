        ...
        <div class="dash-nav dash-nav-dark">
            ...
            <nav class="dash-nav-list">
                <a href="index.php" class="dash-nav-item">
                    ...
                    $rs=mysqli_query($conn,"select * from chapter");
                    while($row=mysqli_fetch_array($rs))
                    {
                    ?> 
                <div class="dash-nav-dropdown">
                    <a href="#" class="dash-nav-item dash-nav-dropdown-toggle"> <?php echo $row['ch_name']; ?></a>
            ...
            <main class="dash-content">
                <div class="container-fluid">
                 <!--   <?php
                   ...
                   abc2('Java','History of Java');
                    ?>
                    <iframe src="file/history_of_java.pdf" class="if" style="height: 450px; width: 1020px; border: none;"></iframe> -->
                        <?php 
                        /*function abc($link)
                        {
                        ?>
